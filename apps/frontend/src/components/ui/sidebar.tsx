...
import { Tooltip, TooltipPanel, TooltipProvider, TooltipTrigger } from '@/components/ui/tooltip';
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip>
      ...
      <TooltipPanel side="right" align="center" hidden={state !== 'collapsed' || isMobile} {...tooltip} />
    </Tooltip>
  );
}
