...
} from '@/components/buttons/animated-button/BaseAnimatedButton';
...
function AnimatedButton({ className, variant, size, ...props }: ButtonProps) {
  return <ButtonPrimitive className={cn(buttonVariants({ variant, size, className }), 'cursor-pointer')} {...props} />;
}

export { AnimatedButton, buttonVariants, type ButtonProps };
