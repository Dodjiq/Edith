...
import { Logo } from '@/app/login/logo';
...
import { FloatingPaths } from '@/app/login/login-component/floating-paths';
      ...
      <div className="relative flex min-h-screen flex-col justify-center p-4">
        ...
        <div className="sm:w-sm mx-auto space-y-4">
          ...
          <div className="flex flex-col space-y-1">
            <h1 className="text-2xl font-bold tracking-wide">Sign In or Join Now!</h1>
            <p className="text-muted-foreground text-base">Login or create your efferd account.</p>
          </div>
