...
export const TimelineUnderlayPreviews: React.FC<{
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" style={outerStyle}>
      {previewState.positions.map((pos) => {
        ...
        const { roundedLeft, width: roundedWidth } = getItemRoundedPosition(timelineItemLeft, timelineItemWidth);
