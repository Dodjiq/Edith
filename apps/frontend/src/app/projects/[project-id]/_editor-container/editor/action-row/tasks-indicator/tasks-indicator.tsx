...
import {assetContextToAssetTasks, assetContextToTranscribingTasks} from './asset-uploads-to-task';
...
export const TasksIndicator: React.FC = () => {
	...
	const tasks = useMemo(() => {
		return getTasks({
			...
			assetTranscribing: assetContextToTranscribingTasks({assetStatus, assets}),
