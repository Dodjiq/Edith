...
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from '../conversation/collapsible';
...
export const QueueItem = ({ className, ...props }: QueueItemProps) => (
  <li
    className={cn('hover:bg-muted group flex flex-col gap-1 rounded-md px-3 py-1 text-sm transition-colors', className)}
    {...props}
  />
);
...
export const QueueItemFile = ({ children, className, ...props }: QueueItemFileProps) => (
  <span className={cn('bg-muted flex items-center gap-1 rounded border px-2 py-1 text-xs', className)} {...props}>
