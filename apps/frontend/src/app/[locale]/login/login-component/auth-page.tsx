...
import { Logo } from '@/app/[locale]/login/logo';
...
import { FloatingPaths } from '@/app/[locale]/login/login-component/floating-paths';
    ...
    <main className="relative md:h-screen md:overflow-hidden lg:grid lg:grid-cols-2">
      <div className="bg-secondary dark:bg-secondary/20 relative hidden h-full flex-col border-r p-10 lg:flex">
        ...
        <div className="z-10 mt-auto">
          <blockquote className="space-y-2">
            ...
            <footer className="font-mono text-sm font-semibold">{t('testimonial_author')}</footer>
          </blockquote>
        </div>
      ...
      <div className="relative flex min-h-screen flex-col justify-center p-4">
        <div aria-hidden className="absolute inset-0 isolate -z-10 opacity-60 contain-strict">
          <div className="-translate-y-87.5 h-320 w-140 absolute right-0 top-0 rounded-full bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,--theme(--color-foreground/.06)_0,hsla(0,0%,55%,.02)_50%,--theme(--color-foreground/.01)_80%)]" />
          <div className="h-320 absolute right-0 top-0 w-60 rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,--theme(--color-foreground/.04)_0,--theme(--color-foreground/.01)_80%,transparent_100%)] [translate:5%_-50%]" />
        ...
        <div className="sm:w-sm mx-auto space-y-4">
          ...
          <div className="flex w-full items-center justify-center">
            ...
            <span className="text-muted-foreground px-2 text-xs">{t('or')}</span>
            <div className="bg-border h-px w-full" />
          </div>
          ...
          <form className="space-y-2">
            ...
            <InputGroup>
              <InputGroupInput placeholder={t('email_placeholder')} type="email" />
              <InputGroupAddon>
                <AtSignIcon />
              </InputGroupAddon>
            </InputGroup>
