...
import {AssetTranscribingProgress} from './asset-transcribing-progress';
	...
	return (
		...
		>
			...
			{tasks.map((task) => {
				...
				if (task.type === 'transcribing') {
					return <AssetTranscribingProgress key={task.id} assetTranscribingTask={task} />;
				}
