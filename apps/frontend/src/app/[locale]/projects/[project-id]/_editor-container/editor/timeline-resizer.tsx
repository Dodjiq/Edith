...
import { getMaxTimelineHeight, getMinTimelineHeight, saveTimelineHeight } from './state/timeline-height-persistance';
...
export const TimelineResizer = () => {
  ...
  return (
    <div className="relative w-full">
      <div className="absolute w-full flex-shrink-0 select-none" style={style} onPointerDown={onPointerDown} />
    </div>
  );
};
