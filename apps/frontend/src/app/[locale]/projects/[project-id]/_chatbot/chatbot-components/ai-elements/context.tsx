...
const ContextIcon = () => {
  ...
  const usedPercent = clampPercent(maxTokens > 0 ? usedTokens / maxTokens : 0);
...
export const ContextContent = ({ className, ...props }: ContextContentProps) => (
  <HoverCardContent
    className={cn(
      'min-w-60 divide-y divide-zinc-200 overflow-hidden border-zinc-200 p-0 dark:divide-zinc-700 dark:border-zinc-700',
      className,
    )}
    {...props}
  />
