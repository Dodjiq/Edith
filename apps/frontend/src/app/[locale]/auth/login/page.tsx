      ...
      <section className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <form action={signIn} className="mt-8 space-y-4">
            ...
            <input name="password" required className="h-12 w-full rounded-md border border-white/[0.08] bg-white/[0.035] px-4 text-sm outline-none transition placeholder:text-[#6f6863] focus:border-[#e7b59f]/50" placeholder={t('password_placeholder')} type="password" />
            <div className="text-right">
              <Link href="/auth/forgot-password" className="text-xs text-[#9f9690] underline-offset-4 hover:text-[#f4f1ed] hover:underline">
